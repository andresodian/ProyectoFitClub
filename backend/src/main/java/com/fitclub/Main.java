...
public class Main {
    public static void main(String[] args) {
        ...
        Membresia membresia = new Membresia(
                100L, socio.getSocioId(), plan.getPlanId(), LocalDate.now(),
                LocalDate.now().plusDays(plan.getDuracionDias()), EstadoMembresia.ACTIVA, OffsetDateTime.now()
        );
        ...
        Notificacion notificacion = new Notificacion(
                1000L, socio.getSocioId(), "¡Bienvenido a FitClub!",
